...
class Shop_model extends CI_Model
{
    ...
    public function addCustomer($data,$address_data)
    {
    ...
    public function getDownloads($limit, $offset, $product_id = null)
    {
        if ($this->loggedIn) {
            ...
            ->where('sales.sale_status', 'Invoiced')->where('sales.payment_status', 'paid')
    ...
    public function getProductBySlug($slug)
    {
      ...
      if($product_price_type=='1'){
         $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_1 as price, {$this->db->dbprefix('products')}.type as type, {$this->db->dbprefix('products')}.second_name as  second_name,{$this->db->dbprefix('products')}.promotion as promotion,{$this->db->dbprefix('products')}.category_id as category_id,{$this->db->dbprefix('products')}.subcategory_id as subcategory_id,{$this->db->dbprefix('products')}.brand as brand,tax_rate,unit");
     }elseif($product_price_type=='2'){

         $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_2 as price, {$this->db->dbprefix('products')}.type as type, {$this->db->dbprefix('products')}.second_name as  second_name,{$this->db->dbprefix('products')}.promotion as promotion,{$this->db->dbprefix('products')}.category_id as category_id,{$this->db->dbprefix('products')}.subcategory_id as subcategory_id,{$this->db->dbprefix('products')}.brand as brand,tax_rate,unit");
     }elseif($product_price_type=='3'){
       $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_3 as price, {$this->db->dbprefix('products')}.type as type, {$this->db->dbprefix('products')}.second_name as  second_name,{$this->db->dbprefix('products')}.promotion as promotion,{$this->db->dbprefix('products')}.category_id as category_id,{$this->db->dbprefix('products')}.subcategory_id as subcategory_id,{$this->db->dbprefix('products')}.brand as brand,tax_rate,unit");
   }elseif($product_price_type=='4'){
      $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_4 as price, {$this->db->dbprefix('products')}.type as type, {$this->db->dbprefix('products')}.second_name as  second_name,{$this->db->dbprefix('products')}.promotion as promotion,{$this->db->dbprefix('products')}.category_id as category_id,{$this->db->dbprefix('products')}.subcategory_id as subcategory_id,{$this->db->dbprefix('products')}.brand as brand,tax_rate,unit");
  }elseif($product_price_type=='5'){
   $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_5 as price, {$this->db->dbprefix('products')}.type as type, {$this->db->dbprefix('products')}.second_name as  second_name,{$this->db->dbprefix('products')}.promotion as promotion,{$this->db->dbprefix('products')}.category_id as category_id,{$this->db->dbprefix('products')}.subcategory_id as subcategory_id,{$this->db->dbprefix('products')}.brand as brand,tax_rate,unit");
}else{
...
$data = $this->db->get_where('products', ['slug' => $slug, 'hide !=' => 1,'status'=>1], 1)->row();
$p_data =$this->db->get_where('contra_price',['customer_id' =>$customer_id,'product_id' =>$data->id])->row();
if($p_data!=''){
...
public function getProductComboItems($pid)
{
    ...
    $q = $this->db->get_where('combo_items', ['product_id' => $pid,'status'=>1]);
    if ($q->num_rows() > 0) {
...
public function getProducts($filters = [])
{
    ...
    $c_data =$this->db->get_where('companies',['id' =>$customer_id])->row();
    $product_price_type=$c_data->product_price_type;
      //print_r($product_price_type);exit();
    if($product_price_type=='1'){
        $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_1 as price, {$this->db->dbprefix('warehouses_products')}.quantity as quantity, type, promotion, promo_price,price as cprice, start_date, end_date, product_details as details,split,size");
    }elseif($product_price_type=='2'){
        $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_2 as price, {$this->db->dbprefix('warehouses_products')}.quantity as quantity, type, promotion, promo_price,price as cprice, start_date, end_date, product_details as details,split,size");
    }elseif($product_price_type=='3'){
        $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_3 as price, {$this->db->dbprefix('warehouses_products')}.quantity as quantity, type, promotion, promo_price,price as cprice, start_date, end_date, product_details as details,split,size");
    }elseif($product_price_type=='4'){
        $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_4 as price, {$this->db->dbprefix('warehouses_products')}.quantity as quantity, type, promotion, promo_price,price as cprice, start_date, end_date, product_details as details,split,size");
    }elseif($product_price_type=='5'){
        $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price_5 as price, {$this->db->dbprefix('warehouses_products')}.quantity as quantity, type, promotion, promo_price,price as cprice, start_date, end_date, product_details as details,split,size");
    }else{
        $this->db->select("{$this->db->dbprefix('products')}.id as id, {$this->db->dbprefix('products')}.name as name, {$this->db->dbprefix('products')}.code as code, {$this->db->dbprefix('products')}.image as image, {$this->db->dbprefix('products')}.slug as slug, {$this->db->dbprefix('products')}.price, {$this->db->dbprefix('warehouses_products')}.quantity as quantity, type, promotion, promo_price,price as cprice, start_date, end_date, product_details as details,split,size");
    }

    $this->db->from('products');
    $this->db->join('warehouses_products', 'products.id=warehouses_products.product_id', 'left');
        // $this->db->join('promos', 'products.id = promos.product_id', 'left');
        ///$this->db->where('warehouses_products.warehouse_id', $this->shop_settings->warehouse);
    $this->db->where('products.status',1);
    $this->db->where('products.parent_id',0);
    ...
    {              
       $p_data =$this->db->get_where('contra_price',['customer_id' =>$customer_id,'product_id' =>$results->id])->row();
       if($p_data!='')
       {
           $results->cprice=$p_data->price;
        }else
        {
             $results->cprice=0;
        }               
...
public function checkpromotion($product_id)
{
    $cdate = date('Y-m-d');
    $checkpromotion = $this->db->query("select sma_promos.id,sma_promos.type,sma_promos.start_date,sma_promos.end_date,sma_promos.gettype,sma_promos.getamount,sma_promos.percentage,sma_promos.description FROM sma_promos  LEFT JOIN sma_product_discount on sma_product_discount.promo_id=sma_promos.id WHERE sma_promos.start_date <= '$cdate' and sma_promos.end_date >= '$cdate' and sma_product_discount.product_id='$product_id' and sma_promos.type='product_discount'")->row_array();
    if(empty($checkpromotion))
    {
        $checkpromotion = $this->db->query("select id,type,start_date,end_date,gettype,getamount,percentage,description FROM sma_promos  WHERE start_date <= '$cdate' and end_date >= '$cdate' and product2buy='$product_id' and type='buy_get'")->row_array();
    ...
    if(empty($checkpromotion))
    {
      ...
      $checkpromotion=$this->db->query("select sma_promos.id,sma_promos.type,sma_promos.start_date,sma_promos.end_date,sma_promos.gettype,sma_promos.getamount,sma_promos.percentage,sma_promos.description from sma_productbuy left join sma_products on sma_products.id=sma_productbuy.productbuy_id left join sma_promos on sma_promos.id=sma_productbuy.promos_id  where sma_productbuy.productbuy_id='$product_id' and sma_promos.type='combo'")->row_array();
...
public function getdefault_delivery($customer_id){

   return $this->db->get_where('sma_companies', ['id' => $customer_id], 1)->row();
}
...
public function getPromosByProduct($pId)
{
    ...
    $q = $this->db->get_where('promos',['type' => 'buy_get','product2buy'=>$pId]);
    if ($q->num_rows() > 0) {
        foreach (($q->result()) as $row) {
            $data[] = $row;
        }
...
public function getPromosByProduct1($pId)
{
    $today = date('Y-m-d');
         // return $data=$this->db->query("select sma_products.id,sma_promos.id as pid,sma_products.code,sma_promos.quantity as quantity,sma_promos.getquantity,sma_products.name,sma_promos.type,sma_productbuy.productbuy_id as product2buy,sma_productget.product2get as product2get from sma_productbuy left join sma_products on sma_products.id=sma_productbuy.productbuy_id left join sma_promos on sma_promos.id=sma_productbuy.promos_id left join sma_productget on sma_productget.promo_id=sma_productbuy.promos_id  where sma_promos.type='combo' and sma_productbuy.productbuy_id='$pId'")->result();

    return $data = $this->db->select('sma_products.id, sma_promos.id as pid, sma_products.code, sma_promos.quantity as quantity, sma_promos.getquantity, sma_products.name, sma_promos.type,sma_productget.product2get as product2get')
    ->from('sma_productget')
    ->join('sma_promos', 'sma_promos.id = sma_productget.promo_id')
    ->join('sma_productbuy', 'sma_productbuy.promos_id = sma_promos.id')
    ->join('sma_products', 'sma_products.id = sma_productget.product2get')
    ->where('sma_promos.type', 'combo')
    ->where('sma_productbuy.productbuy_id', $pId)
    ->where('sma_promos.start_date <=', $today)
    ->where('sma_promos.end_date >=', $today)
    ->get()->result();
...
public function getPromost()
{
    $today = date('Y-m-d');
    $this->db
    ->group_start()->where('start_date <=', $today)->or_where('start_date IS NULL')->group_end()
    ->group_start()->where('end_date >=', $today)->or_where('end_date IS NULL')->group_end();
    $q = $this->db->get_where('promos', ['type' => 'invoice_amount']);
    if ($q->num_rows() > 0) {
        foreach (($q->result()) as $row) {
            $data[] = $row;
        }
